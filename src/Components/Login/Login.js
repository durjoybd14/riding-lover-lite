...
const Login = () => {
  ...
  return (
    ...
    <Form onSubmit={handleSubmit} style={formStyle}>
      {newUser ? <h3 className="py-3">Create an account</h3> : <h3 className="py-3">Login</h3>}
      ...
      {newUser ? '' :
        <Form.Group controlId="formBasicCheckbox" className=" d-flex justify-content-between">
          ...
          <Form.Text as={Link} to="#" className="text-muted">Forgot Password</Form.Text>
        </Form.Group>}

      {newUser ? <Button className="form-control" variant="primary" type="submit">Create an account</Button> : <Button className="form-control" variant="primary" type="submit">Login</Button>}
